...
urlpatterns = [
    ...
    path('state/get/<str:country_id>/', views.StateAPI.as_view(), name='state_get__api'),
    ...
    path('district/get/<str:state_id>/', views.DistrictAPI.as_view(), name='district_get_api'),
